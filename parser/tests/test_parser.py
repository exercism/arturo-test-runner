...
class TestResultsParser(unittest.TestCase):
    def test_report_single_test_success(self):
        ...
        output, status = build_output(expected_tests, parsed_results, None)
    ...
    def test_report_failure_if_a_test_fails(self):
        ...
        parsed_results = {("Exercise Name", "First Test Failing"): {"passed": False, "output": "expects.be:'true? @[false]"}}
        ...
        self.assertEqual(output["tests"][0]["message"], "expects.be:'expects.be:'true? @[false]")
    ...
    def test_report_error_for_empty_parsed_results(self):
        ...
        output, status = build_output(expected_tests, parsed_results, "An error was encountered running the tests.")
    ...
    def test_report_failure_if_missing_subsequent_test(self):
        ...
        self.assertEqual(output["tests"][2]["message"], "Test was not found in validation results.") 
