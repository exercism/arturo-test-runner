...
4. Replace `Arturo` with your track's name in the `README.md` file
5. Replace any occurances of `exercism/arturo-test-runner` with `exercism/<track>-test-runner` (e.g. `exercism/python-test-runner`)
...
The Docker image to automatically run tests on Arturo solutions submitted to [Exercism].
